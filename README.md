Huffman encoding requires multiple passes to go through the data, and may not be desirable if the data sequence is long. It also relies on the non-uniformity of data. 
