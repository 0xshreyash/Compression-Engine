...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (keepRunning) {
            ...
            /* Give user options to encode or decode */
     ...
     * encode it as a file with the name <filename>-compressed.txt
     */
    ...
    /**
     * Method helps setup both encode and decode mode by asking/taking input etc. s
    ...
    /**
     * Method takes the file to decode as input and calls on the decompressor to
     * decode the file. The reconstructed file is called <filename>-reconstructed.txt
    ...
    public static void enterDecodeMode() {
        ...
        String inputFileRequest = "Please enter the input file you want to decode";
        String fileName = modeSetup(startModeLine, inputFileRequest);
